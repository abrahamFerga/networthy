// Networthy local orchestration — the full Cortex-based stack in one command:
...
var pgPassword = builder.AddParameter("cortex-pg-password", "networthy-dev-only", secret: true);
