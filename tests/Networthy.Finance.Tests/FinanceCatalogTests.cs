    ...
    public void Manifest_ToolList_IsPinned()
    {
        ...
        Assert.All(
            manifest.Tools.Where(t => t.Name is "create_account" or "categorize_transaction" or "edit_transaction"
                or "import_statement" or "assign_import_account" or "approve_import_batch" or "set_account_visibility" or "set_budget" or "set_goal" or "contribute_to_goal" or "update_account_terms" or "set_income_source" or "update_household_settings" or "set_exchange_rate" or "link_transfers" or "unlink_transfer"),
