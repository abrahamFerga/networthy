...
public sealed class StatementExtractionTests
{
    ...
    {
        // Citibanamex "Detalle de Operaciones" (the real-world shape that motivated this):
        // yearless "04 MAY" dates anchored only by the Spanish cut-off date, every transaction a
